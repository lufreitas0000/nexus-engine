...
from orchestrator.worker import process_query_task
...
async def test_process_query_task_success(tmp_path, mock_arxiv_search_xml, mock_arxiv_pdf_content):
    ...
    with patch("orchestrator.worker.ArchiveProcessor.process_archive") as mock_process:
        ...
        with patch("orchestrator.worker.LatexToMarkdownConverter.convert") as mock_convert:
