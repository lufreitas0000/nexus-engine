...
async def main():
    ...
    system_instructions = (
        ...
        "5. Export completed graphs to Obsidian using export_to_obsidian().\n"
    ...
    config = LocalAgentConfig(
        ...
        tools=[push_arxiv_query, read_dlq, check_completed_graphs, export_to_obsidian],
        capabilities=CapabilitiesConfig(),
    ...
    print("[INFO] Tools loaded: push_arxiv_query, read_dlq, check_completed_graphs, export_to_obsidian, semantic_search_papers")
