...
def main():
    ...
    if st.session_state.step == 1:
        ...
        edited_md = st.text_area("Markdown Content", value=st.session_state.md_content, height=400)
        ...
        with st.spinner("Compiling EPUB..."):
            try:
                epub_path_temp = convert_markdown_to_epub(md_file_path, hardware_constraints=target_hardware)
                ...
                st.write(f"- Compiled Artifact: {archived_path.name} | Size: {size_mb:.2f} MB")
